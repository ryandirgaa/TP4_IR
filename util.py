...
def sorted_merge_posts_and_tfs(posts_tfs1, posts_tfs2):
    ...
    """
   # TODO Done
   # Source: https://stackoverflow.com/questions/11653917/python-easiest-way-to-sum-list-intersection-of-list-of-tuples

    result = {}
    for k, v in posts_tfs1 + posts_tfs2:
