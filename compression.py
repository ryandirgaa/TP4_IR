...
class VBEPostings:
    ...
    def encode(postings_list):
        ...
        return array.array('L', gap_based_list).tobytes()
    ...
    def decode(encoded_postings_list):
        ...
        """
        # TODO
        decoded_gap_based_list = array.array('L')
        decoded_gap_based_list.frombytes(encoded_postings_list)
        
        decoded_postings_list = [] 
        decoded_postings_list.append(decoded_gap_based_list[0])
        for i in range(1, len(decoded_gap_based_list)):            
            decoded_postings_list.append(decoded_gap_based_list[i] + decoded_postings_list[i-1])
